...
public class ShowMail {
    ...
    public static void printMailMessage(List<Message> messageList) throws IOException, MessagingException {
        ...
        for (int i = 0, leng = messageList.size(); i < leng; i++) {
            ...
            String num = re.getBodyText();
            System.out.println("邮件【" + i + "】正文内容:" + num);


            try {
                System.out.println("总计:" + num.substring(num.indexOf("Subtotal") + 8, num.indexOf("Gift")));
                System.out.println("折扣:" + num.substring(num.indexOf("Card-") + 6, num.indexOf("Shipping & Handling")));
                System.out.println("运输费用:" + num.substring(num.indexOf("Shipping & Handling") + 19, num.indexOf("Estimated Tax")));
                System.out.println("预估税:" + num.substring(num.indexOf("Estimated Tax") + 13, num.indexOf("Total")));
                System.out.println("全部:" + num.substring(num.indexOf("Total") + 5, num.indexOf("Nike.com")));
